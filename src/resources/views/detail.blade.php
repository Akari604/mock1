        ...
        <div class="main-content_detail">
            ...
            <div class="main-content_text">
                ...
                <div class="product_comment">
                    <p class="comment">コメント<span>({{ $comment->count() }})</span></p>
                    <div class="user-display">
                        @foreach($users as $user)
                            ...
                            <div class="user_comment">
                                <P class="text_comment">{{ $comment->pivot->text_body }}</p>
                            </div>
                            @endforeach
                        @endforeach
                    </div>
                    <form class="comment-form" action="/item/{{ $item->id }}/post" method="get">
                        <div class="product_message">
                            ...
                            <input type="id" name="item_id" value="{{ $item->id }}" hidden/>
                            <textarea cols="20" rows="5" name="text_body" value="{{ old('text_body') }}" id="text_body" class="message-comment"></textarea>
                        </div>
